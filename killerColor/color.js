/*
Author: Morgan Doocy,ischool@uw.edu
file:color.js
Description Maintains color classes for constructing 
color objects in different formats (rgb, hsl and hex)
*/

var INCLUDE_HASH_IN_HEX = false;
